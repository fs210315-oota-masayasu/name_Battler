...
//        informationManager.setInformationNotice(initInformation)
        battleViewModel.setInformationNotice(initInformation)
        ...
        if (savedInstanceState == null) {
            ...
            battleViewModel.informationNotice.observe(this, Observer {

                // FragmentTransactionのインスタンスを取得
                val fragmentTransaction: FragmentTransaction = fragmentManager.beginTransaction()
//                fragmentTransaction.replace(R.id.status_information_area,
