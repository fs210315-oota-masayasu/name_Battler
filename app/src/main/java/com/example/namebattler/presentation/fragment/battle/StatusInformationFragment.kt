        ...
        binding = FragmentStatusInformationBinding.inflate(inflater,container,false).apply {
            if (savedInstanceState == null) {
                ...
                if (characterInformationList.size != 0){
                    ...
                    fragmentTransactionFirstEnemy.replace(R.id.first_enemy,
                        InformationViewFragment.newInstance(characterInformationList[0])
                    )
                    ...
                    fragmentTransactionSecondEnemy.replace(R.id.second_enemy,
                        InformationViewFragment.newInstance(characterInformationList[1])
                    )
                    ...
                    fragmentTransactionThirdEnemy.replace(R.id.third_enemy,
                        InformationViewFragment.newInstance(characterInformationList[2])
                    )
                    ...
                    fragmentTransactionFirstPlayer.replace(R.id.first_player,
                        InformationViewFragment.newInstance(characterInformationList[3])
                    )
                    ...
                    fragmentTransactionSecondPlayer.replace(R.id.second_player,
                        InformationViewFragment.newInstance(characterInformationList[4])
                    )
                    ...
                    fragmentTransactionThirdPlayer.replace(R.id.third_player,
                        InformationViewFragment.newInstance(characterInformationList[5])
                    )
